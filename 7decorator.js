class Boat {
	...
	// @logError
	pilot(speed) {
		if (speed > 50) throw new Error();
		console.log('Enjoy Your Smooth Boat Ride');
	}
}
...
// 			method(...args);
// 		} catch (e) {
// 			console.log('Oops, boat was shunk...');
// 		}
// 	};
// }
...
// var Boat = _decorate(null, function (_initialize) {
...
// function logError(target, b, c, d) {
//   var method = target.descriptor.value;
